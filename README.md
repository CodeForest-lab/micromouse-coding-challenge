...
As a competitor, you only need to edit the [solutions/solution.py](solutions/solution.py) file. This contains the Solution class and specifically the `get_step()` method that is entry point into your algorithm.
...
```sh
python maze.py --run maze_<index of maze> --solution solutions/solution.py --gui
```
